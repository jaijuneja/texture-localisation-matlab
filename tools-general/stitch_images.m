function [mosaic, mosaic_noref, origin] = stitch_images(im_ref, im_new, H)
...
%
% STITCH_IMAGES
% [mosaic, mosaic_noref, origin] = stitch_images(im_ref, im_new, H)
%
...
% including and excluding the reference image.
%
% Inputs:
