    ...
    for i = 1:nnz(matched_loc_features)
        ...
        if ~isequal(opts.perspDistPenalty, 0)
            [a31_penalty, h31_penalty, a32_penalty, h32_penalty] = ...
                get_penalty_params(cor.H_to_ref{imgID}, opts.perspDistPenalty);
...
h31_ndxs = num_feats_glob*2+3 : 8 : num_feats_glob*2 + num_views*8;
h32_ndxs = num_feats_glob*2+6 : 8 : num_feats_glob*2 + num_views*8;
