...
% Plot local and global features in different colours. Plot should show the
% spread of local features about each global feature, in the global frame
plot(global_feats(1,:) + opts.xOffset, global_feats(2,:) + opts.yOffset, 'r+', ...
    local_feats(1,:) + opts.xOffset, local_feats(2,:) + opts.yOffset, 'bx');
legend('Global Features', 'Local Features');
